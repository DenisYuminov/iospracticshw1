...
let hw = Homework()
let unsortedArray: [Int] = [2 , 13, 5, 102, 12]
let stringsArray: [String] = ["sad", "timur", "mad"]
hw.divideWithRemainder(12, by: 3)
hw.fibonacci(n: 10)
hw.sort(rawArray: unsortedArray)
hw.firstLetter(strings: stringsArray)
hw.filter(array: unsortedArray, condition: ischet(num:))
